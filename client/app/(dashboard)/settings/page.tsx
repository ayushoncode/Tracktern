...
import { User, Mail, Bell, Shield, Palette, LogOut, CheckCircle } from "lucide-react"
                ...
                {[
                  ...
                  >
                    ...
                    >
                      <div
                        className={cn(
                          "w-4 h-4 rounded-full bg-foreground absolute top-1 transition-all",
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Auto-detect application updates
                      </p>
                    </div>
                  </div>
